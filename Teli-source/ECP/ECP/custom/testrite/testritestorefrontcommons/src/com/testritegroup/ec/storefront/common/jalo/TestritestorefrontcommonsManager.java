...
/**
 * This is the extension manager of the Testritestorefrontcommon extension.
 */
public class TestritestorefrontcommonsManager extends GeneratedTestritestorefrontcommonsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TestritestorefrontcommonsManager.class.getName());
	 ...
	 */
	public static TestritestorefrontcommonsManager getInstance()
	{
		return (TestritestorefrontcommonsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TestritestorefrontcommonsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TestritestorefrontcommonsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TestritestorefrontcommonsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TestritestorefrontcommonsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TestritestorefrontcommonsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
