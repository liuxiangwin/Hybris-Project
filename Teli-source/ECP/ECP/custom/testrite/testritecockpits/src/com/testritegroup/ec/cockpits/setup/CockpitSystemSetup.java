 ...
 *
 */
package com.testritegroup.ec.cockpits.setup;
...
import com.testritegroup.ec.cockpits.constants.TestriteCockpitsConstants;
 ...
 */
@SystemSetup(extension = TestriteCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(TestriteCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(TestriteCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						TestriteCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/testritecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
