 ...
 *
 */
package com.testritegroup.ec.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(TestriteFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TestriteFulfilmentProcessConstants.PARENT_PROCESS);
