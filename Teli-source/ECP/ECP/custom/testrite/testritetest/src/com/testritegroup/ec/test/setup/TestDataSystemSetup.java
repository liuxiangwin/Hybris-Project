 ...
 *
 */
package com.testritegroup.ec.test.setup;
...
import com.testritegroup.ec.test.constants.TestriteTestConstants;
import com.testritegroup.ec.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TestriteTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/testritetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/testritetest/import/reviews.impex");
			...
			importImpexFile(context, "/testritetest/import/cstickets.impex");
		}
	}
}
