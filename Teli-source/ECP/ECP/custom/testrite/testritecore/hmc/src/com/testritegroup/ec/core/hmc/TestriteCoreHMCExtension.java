 ...
 *
 */
package com.testritegroup.ec.core.hmc;
...
/**
 * Provides necessary meta information about the testritecore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class TestriteCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(TestriteCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.testritegroup.ec.core.hmc.locales";
